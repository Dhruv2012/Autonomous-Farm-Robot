...
if("TRUE" STREQUAL "TRUE")
  set(mapviz_plugins_SOURCE_PREFIX /home/meet/agribot_ws/src/mapviz_plugins)
  set(mapviz_plugins_DEVEL_PREFIX /home/meet/agribot_ws/devel)
  ...
  set(mapviz_plugins_INSTALL_PREFIX /home/meet/agribot_ws/install)
...
if(NOT "/home/meet/agribot_ws/src/mapviz_plugins/include;/usr/include/x86_64-linux-gnu/qt5/;/usr/include/x86_64-linux-gnu/qt5/QtCore;/usr/lib/x86_64-linux-gnu/qt5//mkspecs/linux-g++;/usr/include/x86_64-linux-gnu/qt5/QtGui;/usr/include;/usr/include/x86_64-linux-gnu/qt5/QtOpenGL;/usr/include/x86_64-linux-gnu/qt5/QtWidgets " STREQUAL " ")
  set(mapviz_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/meet/agribot_ws/src/mapviz_plugins/include;/usr/include/x86_64-linux-gnu/qt5/;/usr/include/x86_64-linux-gnu/qt5/QtCore;/usr/lib/x86_64-linux-gnu/qt5//mkspecs/linux-g++;/usr/include/x86_64-linux-gnu/qt5/QtGui;/usr/include;/usr/include/x86_64-linux-gnu/qt5/QtOpenGL;/usr/include/x86_64-linux-gnu/qt5/QtWidgets")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mapviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/meet/agribot_ws/src/mapviz_plugins/${idir}'.  ${_report}")
    endif()
    _list_append_unique(mapviz_plugins_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mapviz_plugins;/usr/lib/x86_64-linux-gnu/libQt5Core.so.5.9.5;/usr/lib/x86_64-linux-gnu/libQt5Gui.so.5.9.5;/usr/lib/x86_64-linux-gnu/libQt5OpenGL.so.5.9.5;/usr/lib/x86_64-linux-gnu/libQt5Widgets.so.5.9.5")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT mapviz_plugins_NUM_DUMMY_TARGETS)
      set(mapviz_plugins_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mapviz_plugins::wrapped-linker-option${mapviz_plugins_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mapviz_plugins_NUM_DUMMY_TARGETS "${mapviz_plugins_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mapviz_plugins::wrapped-linker-option${mapviz_plugins_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mapviz_plugins_LIBRARIES "${interface_target_name}")
...
set(mapviz_plugins_EXPORTED_TARGETS "")
