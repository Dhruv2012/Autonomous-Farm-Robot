...
(cl:defmethod cl:initialize-instance :after ((m <Float64Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name marti_common_msgs-msg:<Float64Stamped> is deprecated: use marti_common_msgs-msg:Float64Stamped instead.")))
...
(cl:defmethod value-val ((m <Float64Stamped>))
