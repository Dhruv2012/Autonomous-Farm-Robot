...
class Int64Stamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Int64Stamped(null);
  ...
  static datatype() {
    ...
    return 'marti_common_msgs/Int64Stamped';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'efa2f4712f19644c45429fe3d450cc37';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Int64Stamped(null);
