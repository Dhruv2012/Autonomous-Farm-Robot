...
class UInt32Stamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new UInt32Stamped(null);
  ...
  static datatype() {
    ...
    return 'marti_common_msgs/UInt32Stamped';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '438dd455da526a293dd9eb06485f8a89';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UInt32Stamped(null);
