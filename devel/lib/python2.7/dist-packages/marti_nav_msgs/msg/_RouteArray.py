...
"""autogenerated by genpy from marti_nav_msgs/RouteArray.msg. Do not edit."""
import sys
...
class RouteArray(genpy.Message):
  _md5sum = "a2f93d3e8f926d3456c8a282d8869e1f"
  _type = "marti_nav_msgs/RouteArray"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# list of muliple routes, for instance to support multi-lane roads
...
string value
"""
  __slots__ = ['header','routes','properties']
  _slot_types = ['std_msgs/Header','marti_nav_msgs/Route[]','marti_common_msgs/KeyValue[]']
