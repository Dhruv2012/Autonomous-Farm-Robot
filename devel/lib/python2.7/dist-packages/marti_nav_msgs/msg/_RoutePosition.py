...
"""autogenerated by genpy from marti_nav_msgs/RoutePosition.msg. Do not edit."""
import sys
...
class RoutePosition(genpy.Message):
  _md5sum = "7b490dd73143bf1ce8ca12b9478c3d9d"
  _type = "marti_nav_msgs/RoutePosition"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Position along route
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RoutePosition, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.route_id = str[start:end].decode('utf-8')
      else:
