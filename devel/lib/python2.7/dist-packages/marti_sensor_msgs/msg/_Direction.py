...
"""autogenerated by genpy from marti_sensor_msgs/Direction.msg. Do not edit."""
import sys
...
class Direction(genpy.Message):
  _md5sum = "f4fcbfc7e6f35aa53be850d25834349c"
  _type = "marti_sensor_msgs/Direction"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Direction of vehicle motion
#
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_b().pack(self.direction))
