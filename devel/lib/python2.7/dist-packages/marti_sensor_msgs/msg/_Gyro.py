...
"""autogenerated by genpy from marti_sensor_msgs/Gyro.msg. Do not edit."""
import sys
...
class Gyro(genpy.Message):
  _md5sum = "f2ad455b27f86b992b2cad5af4af11ba"
  _type = "marti_sensor_msgs/Gyro"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Single axis gyro reading.
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2d().pack(_x.angular_rate, _x.variance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.angular_rate, _x.variance,) = _get_struct_2d().unpack(str[start:end])
      return self
