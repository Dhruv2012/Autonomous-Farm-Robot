...
"""autogenerated by genpy from marti_sensor_msgs/Velocity.msg. Do not edit."""
import sys
...
class Velocity(genpy.Message):
  _md5sum = "d9f90fa9bf91df1f2554f047ca0b59f2"
  _type = "marti_sensor_msgs/Velocity"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Single axis linear velocity reading.
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2d().pack(_x.velocity, _x.variance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.velocity, _x.variance,) = _get_struct_2d().unpack(str[start:end])
      return self
