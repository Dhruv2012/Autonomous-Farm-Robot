...
public:
    ...
    void setupUi(QWidget *pose_config)
    {
        if (pose_config->objectName().isEmpty())
            pose_config->setObjectName(QStringLiteral("pose_config"));
        pose_config->resize(400, 222);
        pose_config->setStyleSheet(QStringLiteral(""));
    ...
    {
        pose_config->setWindowTitle(QApplication::translate("pose_config", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("pose_config", "Topic:", Q_NULLPTR));
        selecttopic->setText(QApplication::translate("pose_config", "Select", Q_NULLPTR));
        label_3->setText(QApplication::translate("pose_config", "Color:", Q_NULLPTR));
        color->setText(QString());
        label_7->setText(QApplication::translate("pose_config", "Draw Style:", Q_NULLPTR));
        drawstyle->clear();
        drawstyle->insertItems(0, QStringList()
         << QApplication::translate("pose_config", "lines", Q_NULLPTR)
         << QApplication::translate("pose_config", "points", Q_NULLPTR)
         << QApplication::translate("pose_config", "arrows", Q_NULLPTR)
        );
        label_8->setText(QApplication::translate("pose_config", "Static Arrow Sizes:", Q_NULLPTR));
        static_arrow_sizes->setText(QString());
        label_4->setText(QApplication::translate("pose_config", "Position Tolerance:", Q_NULLPTR));
        positiontolerance->setSuffix(QString());
        label_6->setText(QApplication::translate("pose_config", "Buffer Size:", Q_NULLPTR));
        buttonResetBuffer->setText(QApplication::translate("pose_config", "Clear", Q_NULLPTR));
        label_5->setText(QApplication::translate("pose_config", "Show Laps", Q_NULLPTR));
        show_laps->setText(QString());
        label_2->setText(QApplication::translate("pose_config", "Status:", Q_NULLPTR));
        status->setText(QApplication::translate("pose_config", "No topic", Q_NULLPTR));
    } // retranslateUi
