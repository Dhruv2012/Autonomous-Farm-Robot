...
void mapviz_plugins::RoutePlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        RoutePlugin *_t = static_cast<RoutePlugin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject mapviz_plugins::RoutePlugin::staticMetaObject = {
    { &mapviz::MapvizPlugin::staticMetaObject, qt_meta_stringdata_mapviz_plugins__RoutePlugin.data,
      qt_meta_data_mapviz_plugins__RoutePlugin,  qt_static_metacall, nullptr, nullptr}
};
