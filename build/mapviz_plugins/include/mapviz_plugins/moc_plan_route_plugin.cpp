...
void mapviz_plugins::PlanRoutePlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PlanRoutePlugin *_t = static_cast<PlanRoutePlugin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject mapviz_plugins::PlanRoutePlugin::staticMetaObject = {
    { &mapviz::MapvizPlugin::staticMetaObject, qt_meta_stringdata_mapviz_plugins__PlanRoutePlugin.data,
      qt_meta_data_mapviz_plugins__PlanRoutePlugin,  qt_static_metacall, nullptr, nullptr}
};
