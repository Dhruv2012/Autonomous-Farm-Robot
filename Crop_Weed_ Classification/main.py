...
if(MODEL == training_model["unet"]):
    ...
    if(retrain == False):
        ...
        seg_model = load_model("/home/dhruv/Final_Year_Project/Crop_Weed_ Classification/cropvsweedv1.h5")
...
history = seg_model.fit(x_train, y_train, batch_size=4, epochs= 50,verbose=1,validation_data = (x_test,y_test),shuffle = True)
seg_model.save("/home/dhruv/Final_Year_Project/Crop_Weed_ Classification/cropvsweedv1.h5")
