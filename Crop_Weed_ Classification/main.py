...
if(MODEL == training_model["unet"]):
    ...
    if(retrain == False):
        ...
        seg_model.compile(loss = "categorical_crossentropy",optimizer = "Adam",  metrics=['accuracy'])
        print("crop vs weeds model loaded...")
    x_train,y_train,x_test,y_test = load_cwfid_witihyaml(path_x,path_y,"/home/dhruv/Final_Year_Project/Datasets/cwfid dataset(Annotated)/WithAnnotations/train_test_split.yaml",h,w)
...
plt.imshow(np.reshape(y_test[14,:],(h,w,3)))


prediction = seg_model.predict(x_test[14:15])
...
imgs_x = []
imgs_y = []
test_imgx = "/home/dhruv/Final_Year_Project/Datasets/BoniRob dataset/ijrr_sugarbeets_2016_annotations/CKA_160517/images/rgb/bonirob_2016-05-17-11-42-26_14_frame250.png"
imgx = multichannel_input(test_imgx,h,w)
imgs_x.append(imgx)
test_imgy = "/home/dhruv/Final_Year_Project/Datasets/BoniRob dataset/ijrr_sugarbeets_2016_annotations/CKA_160517/annotations/dlp/colorCleaned/bonirob_2016-05-17-11-42-26_14_frame250.png"
...
plt.imshow(np.reshape(prediction,(h,w,3)))
print("hey")
image = load_img(test_imgx,target_size=(h,w))
plt.subplot(2,1,1)
